...
class SNA_PT_ICITY_EDITOR_6D34D(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row_C774B.template_icon(icon_value=load_preview_icon(os.path.join(os.path.dirname(__file__), 'assets', 'jocker.png')), scale=(6 if property_exists("bpy.data.collections['ICity']", globals(), locals()) else 6))
...
# bpy.ops.sna.material_filter_f04c3()
# bpy.ops.sna.road_materials_filter_6a3ec()
# bpy.context.scene.sna_road_materials_browser = 'ICity_Road 2 dirty 2_Default'
# bpy.ops.sna.road_apply_5c3ab()
# bpy.context.scene.sna_road_materials_type_ = 'Curb'
# bpy.ops.sna.material_filter_f04c3()
# bpy.ops.sna.road_materials_filter_6a3ec()
# bpy.context.scene.sna_road_materials_browser = 'ICity_Curb grey black_Default'
# bpy.ops.sna.road_apply_5c3ab()
# bpy.context.scene.sna_road_materials_type_ = 'Sidewalk'
# bpy.ops.sna.material_filter_f04c3()
# bpy.ops.sna.road_materials_filter_6a3ec()
# bpy.context.scene.sna_road_materials_browser = 'ICity_Sidewalk 3_Default'
# bpy.ops.sna.road_apply_5c3ab()
#
# # 树
# bpy.context.scene.sna_street_asset_type = 'Tree'
# bpy.context.scene.sna_street_asset_browser = 'Tree1_Tree_ICity_Default'
# # bpy.ops.mesh.attribute_set(value_bool=True)
# bpy.ops.sna.road_apply_5c3ab()
#
# # 路灯
# bpy.context.scene.sna_street_asset_type = 'Light'
# bpy.context.scene.sna_street_asset_browser = 'Light4_Light_ICity_Default'
# # bpy.ops.mesh.attribute_set(value_bool=False)
# bpy.ops.sna.road_apply_5c3ab()
#
# # 灯光
# bpy.context.scene.sna_street_asset_type = 'Traffic light'
# bpy.data.lights["ICity Road light"].energy = 300
# bpy.data.lights["ICity Road light"].color = (1, 0.587094, 0.150187)
#
# # 系船柱
# bpy.context.scene.sna_street_asset_type = 'Bollard'
# bpy.context.scene.sna_street_asset_browser = 'Bollard9_Bollard_Default_ICity'
# bpy.ops.mesh.attribute_set(value_bool=True)
# bpy.ops.sna.road_apply_5c3ab()
#
# #长椅
# bpy.context.scene.sna_street_asset_type = 'Bench'
# bpy.context.scene.sna_street_asset_browser = 'Bench1_Bench_ICity_Default'
# bpy.ops.mesh.attribute_set(value_bool=True)
# bpy.ops.sna.road_apply_5c3ab()
#
# # 基础设施
# bpy.context.scene.sna_street_asset_type = 'Services'
# bpy.context.scene.sna_street_asset_browser = 'Services_Default'
# bpy.ops.mesh.attribute_set(value_bool=True)
# bpy.ops.sna.road_apply_5c3ab()
#
# bpy.context.scene.sna_street_assetoptions = 'Options'
